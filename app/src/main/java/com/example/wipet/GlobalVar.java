...
public class GlobalVar {
    ...
    //Variable UserInfo
    public static final String VAR_IS_LOGGED_IN = "VAR_IS_LOGGED_IN";
    public static final String VAR_TOKEN = "VAR_TOKEN";
    public static final String VAR_ID_USER = "VAR_ID_USER";
